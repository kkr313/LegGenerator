...
export class AirService {
  ...
  FileData: any = {
    ...
    origin_portcode: AirData.AIR[0].L1.col3.key,
    origin_portcode_value: AirData.AIR[0].L3.col2.value,
    destination_portcode: AirData.AIR[0].L1.col4.key,
    destination_portcode_value: AirData.AIR[0].L3.col1.value,
    ...
    origin: AirData.AIR[0].L1.col1.key,
    origin_value: AirData.AIR[0].L1.col1.value,
    destination: AirData.AIR[0].L1.col2.key,
    destination_value: AirData.AIR[0].L1.col2.value,
    origin_pincode: AirData.AIR[0].L1.col5.key,
    origin_pincode_value: AirData.AIR[0].L1.col5.value,
    destination_pincode: AirData.AIR[0].L1.col6.key,
    destination_pincode_value: AirData.AIR[0].L1.col6.value,
    origin_country_code: AirData.AIR[0].L1.col7.key,
    origin_country_code_value: AirData.AIR[0].L1.col7.value,
    destination_country_code: AirData.AIR[0].L1.col8.key,
    destination_country_code_value: AirData.AIR[0].L1.col8.value,
    origin_state_code: AirData.AIR[0].L1.col9.key,
    origin_state_code_value: AirData.AIR[0].L1.col9.value,
    destination_state_code: AirData.AIR[0].L1.col10.key,
    destination_state_code_value: AirData.AIR[0].L1.col10.value,
    impo_expo: AirData.AIR[0].L1.col11.key,
    impo_expo_value: AirData.AIR[0].L1.col11.value,
    transport_mode: AirData.AIR[0].L1.col12.key,
    transport_mode_value: AirData.AIR[0].L1.col12.value,
    no_of_axle: AirData.AIR[0].L1.col13.key,
    no_of_axle_value: AirData.AIR[0].L1.col13.value,
    distance_range: AirData.AIR[0].L1.col14.key,
    distance_range_value: AirData.AIR[0].L1.col14.value,
    distance_unit: AirData.AIR[0].L1.col15.key,
    distance_unit_value: AirData.AIR[0].L1.col15.value,
    volume_range: AirData.AIR[0].L1.col16.key,
    volume_range_value: AirData.AIR[0].L1.col16.value,
    volume_unit: AirData.AIR[0].L1.col17.key,
    volume_unit_value: AirData.AIR[0].L1.col17.value,
    weight_range: AirData.AIR[0].L1.col18.key,
    weight_range_value: AirData.AIR[0].L1.col18.value,
    weight_unit: AirData.AIR[0].L1.col19.key,
    weight_unit_value: AirData.AIR[0].L1.col19.value,

    charge1_l1_name: AirData.AIR[0].L1.charges1.charge_name_key,
    charge1_l1_name_value: AirData.AIR[0].L1.charges1.charge_name_value,
    charge1_l1_min: AirData.AIR[0].L1.charges1.charge_name_min_key,
    charge1_l1_min_value: AirData.AIR[0].L1.charges1.charge_name_min_value,
    charge1_l1_basis: AirData.AIR[0].L1.charges1.charge_basis_key,
    charge1_l1_basis_value: AirData.AIR[0].L1.charges1.charge_basis_value,
    charge1_l1_currency: AirData.AIR[0].L1.charges1.charge_currency_key,
    charge1_l1_currency_value: AirData.AIR[0].L1.charges1.charge_currency_value,
    charge2_l1_name: AirData.AIR[0].L1.charges2.charge_name_key,
    charge2_l1_name_value: AirData.AIR[0].L1.charges2.charge_name_value,
    charge2_l1_min: AirData.AIR[0].L1.charges2.charge_name_min_key,
    charge2_l1_min_value: AirData.AIR[0].L1.charges2.charge_name_min_value,
    charge2_l1_basis: AirData.AIR[0].L1.charges2.charge_basis_key,
    charge2_l1_basis_value: AirData.AIR[0].L1.charges2.charge_basis_value,
    charge2_l1_currency: AirData.AIR[0].L1.charges2.charge_currency_key,
    charge2_l1_currency_value: AirData.AIR[0].L1.charges2.charge_currency_value,
    charge3_l1_name: AirData.AIR[0].L1.charges3.charge_name_key,
    charge3_l1_name_value: AirData.AIR[0].L1.charges3.charge_name_value,
    charge3_l1_min: AirData.AIR[0].L1.charges3.charge_name_min_key,
    charge3_l1_min_value: AirData.AIR[0].L1.charges3.charge_name_min_value,
    charge3_l1_basis: AirData.AIR[0].L1.charges3.charge_basis_key,
    charge3_l1_basis_value: AirData.AIR[0].L1.charges3.charge_basis_value,
    charge3_l1_currency: AirData.AIR[0].L1.charges3.charge_currency_key,
    charge3_l1_currency_value: AirData.AIR[0].L1.charges3.charge_currency_value,
    charge4_l1_name: AirData.AIR[0].L1.charges4.charge_name_key,
    charge4_l1_name_value: AirData.AIR[0].L1.charges4.charge_name_value,
    charge4_l1_min: AirData.AIR[0].L1.charges4.charge_name_min_key,
    charge4_l1_min_value: AirData.AIR[0].L1.charges4.charge_name_min_value,
    charge4_l1_basis: AirData.AIR[0].L1.charges4.charge_basis_key,
    charge4_l1_basis_value: AirData.AIR[0].L1.charges4.charge_basis_value,
    charge4_l1_currency: AirData.AIR[0].L1.charges4.charge_currency_key,
    charge4_l1_currency_value: AirData.AIR[0].L1.charges4.charge_currency_value,
    charge5_l1_name: AirData.AIR[0].L1.charges5.charge_name_key,
    charge5_l1_name_value: AirData.AIR[0].L1.charges5.charge_name_value,
    charge5_l1_min: AirData.AIR[0].L1.charges5.charge_name_min_key,
    charge5_l1_min_value: AirData.AIR[0].L1.charges5.charge_name_min_value,
    charge5_l1_basis: AirData.AIR[0].L1.charges5.charge_basis_key,
    charge5_l1_basis_value: AirData.AIR[0].L1.charges5.charge_basis_value,
    charge5_l1_currency: AirData.AIR[0].L1.charges5.charge_currency_key,
    charge5_l1_currency_value: AirData.AIR[0].L1.charges5.charge_currency_value,

    charge1_l5_name: AirData.AIR[0].L5.charges1.charge_name_key,
    charge1_l5_name_value: AirData.AIR[0].L5.charges1.charge_name_value,
    charge1_l5_min: AirData.AIR[0].L5.charges1.charge_name_min_key,
    charge1_l5_min_value: AirData.AIR[0].L5.charges1.charge_name_min_value,
    charge1_l5_basis: AirData.AIR[0].L5.charges1.charge_basis_key,
    charge1_l5_basis_value: AirData.AIR[0].L5.charges1.charge_basis_value,
    charge1_l5_currency: AirData.AIR[0].L5.charges1.charge_currency_key,
    charge1_l5_currency_value: AirData.AIR[0].L5.charges1.charge_currency_value,
    charge2_l5_name: AirData.AIR[0].L5.charges2.charge_name_key,
    charge2_l5_name_value: AirData.AIR[0].L5.charges2.charge_name_value,
    charge2_l5_min: AirData.AIR[0].L5.charges2.charge_name_min_key,
    charge2_l5_min_value: AirData.AIR[0].L5.charges2.charge_name_min_value,
    charge2_l5_basis: AirData.AIR[0].L5.charges2.charge_basis_key,
    charge2_l5_basis_value: AirData.AIR[0].L5.charges2.charge_basis_value,
    charge2_l5_currency: AirData.AIR[0].L5.charges2.charge_currency_key,
    charge2_l5_currency_value: AirData.AIR[0].L5.charges2.charge_currency_value,
    charge3_l5_name: AirData.AIR[0].L5.charges3.charge_name_key,
    charge3_l5_name_value: AirData.AIR[0].L5.charges3.charge_name_value,
    charge3_l5_min: AirData.AIR[0].L5.charges3.charge_name_min_key,
    charge3_l5_min_value: AirData.AIR[0].L5.charges3.charge_name_min_value,
    charge3_l5_basis: AirData.AIR[0].L5.charges3.charge_basis_key,
    charge3_l5_basis_value: AirData.AIR[0].L5.charges3.charge_basis_value,
    charge3_l5_currency: AirData.AIR[0].L5.charges3.charge_currency_key,
    charge3_l5_currency_value: AirData.AIR[0].L5.charges3.charge_currency_value,
    charge4_l5_name: AirData.AIR[0].L5.charges4.charge_name_key,
    charge4_l5_name_value: AirData.AIR[0].L5.charges4.charge_name_value,
    charge4_l5_min: AirData.AIR[0].L5.charges4.charge_name_min_key,
    charge4_l5_min_value: AirData.AIR[0].L5.charges4.charge_name_min_value,
    charge4_l5_basis: AirData.AIR[0].L5.charges4.charge_basis_key,
    charge4_l5_basis_value: AirData.AIR[0].L5.charges4.charge_basis_value,
    charge4_l5_currency: AirData.AIR[0].L5.charges4.charge_currency_key,
    charge4_l5_currency_value: AirData.AIR[0].L5.charges4.charge_currency_value,
    charge5_l5_name: AirData.AIR[0].L5.charges5.charge_name_key,
    charge5_l5_name_value: AirData.AIR[0].L5.charges5.charge_name_value,
    charge5_l5_min: AirData.AIR[0].L5.charges5.charge_name_min_key,
    charge5_l5_min_value: AirData.AIR[0].L5.charges5.charge_name_min_value,
    charge5_l5_basis: AirData.AIR[0].L5.charges5.charge_basis_key,
    charge5_l5_basis_value: AirData.AIR[0].L5.charges5.charge_basis_value,
    charge5_l5_currency: AirData.AIR[0].L5.charges5.charge_currency_key,
    charge5_l5_currency_value: AirData.AIR[0].L5.charges5.charge_currency_value,
