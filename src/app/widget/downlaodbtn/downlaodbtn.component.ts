    ...
    let l4chadata = JSON.parse(localStorage.getItem('L4ChadataSource')!);
     this.legsData={
      ...
      L4ChaData :[{
        ...
        loading_unloading: l4chadata.charge1_l2cha_name_value,
        loading_unloading_basis: l4chadata.charge1_l2cha_basis_value,
        loading_unloading_currency: l4chadata.charge1_l2cha_currency_value,
        customs_clearance_per_bl: l4chadata.charge2_l2cha_name_value,
        customs_clearance_per_bl_basis: l4chadata.charge2_l2cha_basis_value,
        customs_clearance_per_bl_currency: l4chadata.charge2_l2cha_currency_value,
        additional_customs_entry_fee: l4chadata.charge3_l2cha_name_value,
        additional_customs_entry_fee_basis: l4chadata.charge3_l2cha_basis_value,
        additional_customs_entry_fee_currency: l4chadata.charge3_l2cha_currency_value,
        customs_documentation_fee_at_destination: l4chadata.charge4_l2cha_name_value,
        customs_documentation_fee_at_destination_basis: l4chadata.charge4_l2cha_basis_value,
        customs_documentation_fee_at_destination_currency: l4chadata.charge4_l2cha_currency_value,
        import_customs_brokerage: l4chadata.charge5_l2cha_name_value,
        import_customs_brokerage_basis: l4chadata.charge5_l2cha_basis_value,
        import_customs_brokerage_currency: l4chadata.charge5_l2cha_currency_value,
      }],
