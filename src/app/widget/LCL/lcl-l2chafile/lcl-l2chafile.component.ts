...
@Component({
  selector: 'app-lcl-l2chafile',
  templateUrl: './lcl-l2chafile.component.html',
  styleUrls: ['./lcl-l2chafile.component.css']
})
export class LclL2chafileComponent implements OnInit {
  ...
  updateNewValue(get: any, key: string) {
    ...
    localStorage.setItem('L2ChadataSource', JSON.stringify(this.lclService.FileData));
  }
