...
@Component({
  selector: 'app-lcl-l2file',
  templateUrl: './lcl-l2file.component.html',
  styleUrls: ['./lcl-l2file.component.css']
})
export class LclL2fileComponent implements OnInit {
  ...
  updateNewValue(get: any, key: string) {
    ...
    localStorage.setItem('L2dataSource', JSON.stringify(this.lclService.FileData));
  }
