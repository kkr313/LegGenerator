...
@Component({
  selector: 'app-air-l4chafile',
  templateUrl: './air-l4chafile.component.html',
  styleUrls: ['./air-l4chafile.component.css']
})
export class AirL4chafileComponent implements OnInit {
  ...
  updateNewValue(get: any, key: string) {
    ...
    localStorage.setItem('L4ChadataSource', JSON.stringify(this.airService.FileData));
  }
