...
@Component({
  selector: 'app-air-l3file',
  templateUrl: './air-l3file.component.html',
  styleUrls: ['./air-l3file.component.css']
})
export class AirL3fileComponent implements OnInit {
  ...
  updateNewValue(get: any, key: string) {
    ...
    localStorage.setItem('L3dataSource', JSON.stringify(this.airService.FileData));
  }
