...
@Component({
  selector: 'app-air-l4file',
  templateUrl: './air-l4file.component.html',
  styleUrls: ['./air-l4file.component.css']
})
export class AirL4fileComponent implements OnInit {
  ...
  updateNewValue(get: any, key: string) {
    ...
    localStorage.setItem('L4dataSource', JSON.stringify(this.airService.FileData));
  }
