...
@Component({
  selector: 'app-air-l1file',
  templateUrl: './air-l1file.component.html',
  styleUrls: ['./air-l1file.component.css']
})
export class AirL1fileComponent implements OnInit {
  ...
  updateNewValue(get: any, key: string) {
    ...
    localStorage.setItem('L1dataSource', JSON.stringify(this.airService.FileData));
  }
