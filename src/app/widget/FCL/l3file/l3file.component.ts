...
export class L3fileComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.commonService.updateValue.subscribe((Res: any) => {
      if (Res) {
          ...
          this.charge1_name_key = Res?. charge1_name;
          this.charge1_name_value = Res?. charge1_name_value;
          this.charge1_basis_key = Res?. charge1_basis;
          this.charge1_basis_value = Res?. charge1_basis_value;
          this.charge1_currency_key = Res?. charge1_currency;
          this.charge1_currency_value = Res?. charge1_currency_value;
          this.charge2_name_key = Res?. charge2_name;
          this.charge2_name_value = Res?. charge2_name_value;
          this.charge2_basis_key = Res?. charge2_basis;
          this.charge2_basis_value = Res?. charge2_basis_value;
          this.charge2_currency_key = Res?. charge2_currency;
          this.charge2_currency_value = Res?. charge2_currency_value;
          this.charge3_name_key = Res?. charge3_name;
          this.charge3_name_value = Res?. charge3_name_value;
          this.charge3_basis_key = Res?. charge3_basis;
          this.charge3_basis_value = Res?. charge3_basis_value;
          this.charge3_currency_key = Res?. charge3_currency;
          this.charge3_currency_value = Res?. charge3_currency_value;
          this.charge4_name_key = Res?. charge4_name;
          this.charge4_name_value = Res?. charge4_name_value;
          this.charge4_basis_key = Res?. charge4_basis;
          this.charge4_basis_value = Res?. charge4_basis_value;
          this.charge4_currency_key = Res?. charge4_currency;
          this.charge4_currency_value = Res?. charge4_currency_value;
          this.charge5_name_key = Res?. charge5_name;
          this.charge5_name_value = Res?. charge5_name_value;
          this.charge5_basis_key = Res?. charge5_basis;
          this.charge5_basis_value = Res?. charge5_basis_value;
          this.charge5_currency_key = Res?. charge5_currency;
          this.charge5_currency_value = Res?. charge5_currency_value;
      }
  ...
  updateNewValue(get: any, key: string) {
    ...
    localStorage.setItem('dataSource', JSON.stringify(this.commonService.FileData));
  }
